class User:
    def __init__(self, username='', password='', real_name="", email='', gender=None, birthday=None, looking_for=None,
                 here_for=None, music='', fav_books='', is_admin=False):
        ...
        self.here_for = here_for
        self.music = music
        self.favourite_books = fav_books
